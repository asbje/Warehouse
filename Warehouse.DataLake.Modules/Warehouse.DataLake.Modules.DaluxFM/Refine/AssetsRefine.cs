...
{
    public class AssetsRefine : BaseRefine
    {
        ...
        public AssetsRefine(string moduleName, Stream xmlStream, IRefine estates, IRefine buildings, string uniqueHeaders) : base(moduleName, "assets")
        {
