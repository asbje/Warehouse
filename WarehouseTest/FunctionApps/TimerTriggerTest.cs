...
namespace WarehouseTest.FunctionApps
{
    ...
    public class TimerTriggerTest:GenericTest
    {
        ...
        public void RunDaluxFMModuleWithLocaleFiles()
        {
            ...
            var res = Warehouse.FunctionApps.DurableFunctionApp.Run("DaluxFM", Config, loggerMock.Object, new object[] { estatesStream, assetsStream });
        ...
        {
            var loggerMock = new Mock<ILogger>();
            var result = Warehouse.FunctionApps.DurableFunctionApp.Run("DaluxFM", Config, loggerMock.Object);
